  ...
  <div class="main-div">
    ...
    <main>
      <PrimaryContainer v-if="formIsVisible">
        ...
        <input type="text" maxlength="17" placeholder="League name" v-model="newLeagueName">
        <input type="text" maxlength="17" placeholder="Team 1 name" v-model="team1">
        <input type="text" maxlength="17" placeholder="Team 2 name" v-model="team2">
        <input type="text" maxlength="17" placeholder="Team 3 name" v-model="team3">
        <input type="text" maxlength="17" placeholder="Team 4 name" v-model="team4">
